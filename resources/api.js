mws = window.mws || {};
mws.datastash = {
	get: async ( key ) => mws.datastash.getInternal( key, false ),
	getGlobal: async ( key ) => mws.datastash.getInternal( key, true ),
	set: async ( key, value ) => mws.datastash.setInternal( key, value, false ),
	setGlobal: async ( key, value ) => mws.datastash.setInternal( key, value, true ),
